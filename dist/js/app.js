...
requireAll(__webpack_require__("./src/images/icons/sprite_icons sync recursive \\.svg$"));
...
if (utils_constants__WEBPACK_IMPORTED_MODULE_1__.GLOBAL_VARS.projectDevStatus) {
  (0,_dev_vendors_dev_widget__WEBPACK_IMPORTED_MODULE_3__["default"])();
...
(0,utils__WEBPACK_IMPORTED_MODULE_2__.documentReady)(function () {
  readyFunc();
});
...
var getAllClasses = function getAllClasses(context, output) {
  if (output.length) {
    var finalArray = [];
    var mainArray = [];
    ...
    for (var i = 0; i < allElements.length; i++) {
      ...
      var elementClass = someElement.className;
      ...
      if (elementClass.length > 0) {
        ...
        var classesAmount = elementClassArray.length;

        if (classesAmount === 1) {
          mainArray.push(".".concat(elementClassArray[0], " {"));
        } else {
          var cascad = ".".concat(elementClassArray[0], " {");

          for (var j = 1; j < elementClassArray.length; j++) {
            cascad += " &.".concat(elementClassArray[j], " { }");
          }
    ...
    noRepeatingArray.forEach(function (item) {
      ...
      for (var _i2 = 0; _i2 < finalArray.length; ++_i2) {
        var newWords = finalArray[_i2].split('&');

        if (newWords[0] === preWords[0]) {
          has = true;

          for (var _j2 = 0; _j2 < preWords.length; ++_j2) {
            if (newWords.indexOf(preWords[_j2]) < 0) {
              newWords.push(preWords[_j2]);
            }
          }

          finalArray[_i2] = newWords.join('&');
        }
      }
...
/***/ "./src/images/icons/sprite_icons/footer_logo.svg":
/*!*******************************************************!*\
  !*** ./src/images/icons/sprite_icons/footer_logo.svg ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "light-usage",
      viewBox: "0 0 7 15",
      url: "/images/sprite/" + "sprite.svg#light-usage",
      toString: function () {
        return this.url;
      }
    });
...
/***/ "./src/images/icons/sprite_icons/play.svg":
/*!************************************************!*\
  !*** ./src/images/icons/sprite_icons/play.svg ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/images/icons/sprite_icons/rss.svg":
/*!***********************************************!*\
  !*** ./src/images/icons/sprite_icons/rss.svg ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "rss-usage",
      viewBox: "0 0 169.142 73.048",
      url: "/images/sprite/" + "sprite.svg#rss-usage",
      toString: function () {
        return this.url;
      }
    });
...
/***/ "./src/images/icons/sprite_icons/rss_footer.svg":
/*!******************************************************!*\
  !*** ./src/images/icons/sprite_icons/rss_footer.svg ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "rss_footer-usage",
      viewBox: "0 0 168.263 73.049",
      url: "/images/sprite/" + "sprite.svg#rss_footer-usage",
      toString: function () {
        return this.url;
      }
    });
...
/***/ "./src/images/icons/sprite_icons/search.svg":
/*!**************************************************!*\
  !*** ./src/images/icons/sprite_icons/search.svg ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/images/icons/sprite_icons/youtube.svg":
/*!***************************************************!*\
  !*** ./src/images/icons/sprite_icons/youtube.svg ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var map = {
	...
	"./rss_footer.svg": "./src/images/icons/sprite_icons/rss_footer.svg",
	"./search.svg": "./src/images/icons/sprite_icons/search.svg",
	"./twitter.svg": "./src/images/icons/sprite_icons/twitter.svg",
	"./youtube.svg": "./src/images/icons/sprite_icons/youtube.svg"
};
